                  ...
                  {file ? (
                    <div className="flex flex-col items-center">
                      <img 
                        ...
                        alt="Preview" 
                        className="h-32 w-32 object-contain rounded-xl mb-3 shadow-md bg-white p-2"
                      />
                    ...
                    <div className="flex flex-col items-center">
                      <div className="h-12 w-12 rounded-xl flex items-center justify-center mb-3 bg-white text-slate-400 shadow-sm border border-slate-100">
