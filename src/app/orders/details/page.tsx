          ...
          {Object.entries(groupedByCustomer).map(([customer, rows]) => (
            <div key={customer} className="space-y-8 animate-in fade-in slide-in-from-top-4 duration-700">
              ...
              <div className="flex justify-end mb-4">
                  <button 
                  onClick={() => router.push(`/orders/print?order_number=${orderNumber}&customer=${customer}`)}
                  className="px-6 py-3 bg-slate-900 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-blue-600 transition-all flex items-center gap-3 shadow-lg shadow-blue-100"
                  >
